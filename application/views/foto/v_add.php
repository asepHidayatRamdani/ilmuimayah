      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form action="<?= base_url('foto/aksi_tambah') ?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  <input type="text" class="form-control" name="idFoto" value="<?= $max + 1 ?>" id="" placeholder="id Foto">
                </div>
                <div class="form-group">
                  <label for="" class="label">File Foto</label>
                  <input type="file" class="form-control-file" name="fileFoto" id="" placeholder="File Foto">
                </div>

                <div class="form-group">
                  <input type="text" class="form-control" name="tanggalFoto" id="" placeholder="Keterangan">
                </div>
