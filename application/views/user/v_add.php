            ...
            <div class="card-body">
              <form action="<?= base_url('user/aksi_tambah') ?>" method="POST">
                <div class="form-group">
                  <input type="text" class="form-control" name="idUser" value="<?= $max + 1 ?>" id="" placeholder="id User">
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="namaUser" id="" placeholder="Nama User">
                </div>
                <div class="form-group">
